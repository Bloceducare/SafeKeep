...
const Home= () => {
  ...
  return (
    <div>
        <div className="bodi pt-5">
<Container style={{ height: '100vh', zIndex: '0', position:'relative' }}>
  <Row  >
    ...
    <div className="">
            <div className="">
              <img className="w-100 animate__animated animate__bounce BgLogo pt-5" src="/images/LogoBlack.png" alt="eth logo"/>
            </div>
    </div>
    </Col>
  </Row>
