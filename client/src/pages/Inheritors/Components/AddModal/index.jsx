...
const prevData = { weiShare:'', address:'' }
function AddModal() {
...
const handleSubmit = (e) => {
  ...
  <Row className="mb-4">
    <Form.Group as={Col} controlId="formGridPassword">
      <FormControl type="number" placeholder="Amount" onChange = {handleChange} name ='wei-share'/>
    </Form.Group>
  </Row>

<div className ='d-flex justify-content-center align-items-center'>
    <CustomButton disabled = {crud} text = {`${crud ? 'Loading...':'Allocate'}`} size ='small' />
</div>
          </Form>
