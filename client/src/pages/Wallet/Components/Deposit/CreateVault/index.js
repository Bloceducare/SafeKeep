...
const colourOptions = [
  {
    value: "0x0D2eE7dAB13330455b7f1b7898448cA2d3d78C41",
    label: "0x0D2eE7dAB13330455b7f1b7898448cA2d3d78C41",
  },
  {
    value: "0x0D2eE7dAB13330455b7f1b7898448cA2d3d78C41",
    label: "0x0D2eE7dAB13330455b7f1b7898448cA2d3d78C41",
...
function CreateVaultModal() {
  ...
  const handleSubmit = (e) => {
    ...
    for (let i = 0; i < inheritors.length; i++) {
      if (!ethers.utils.getAddress(inheritors[i]))
        return "one or more invalid wallet address";
    }

    if (!ethers.utils.getAddress(_backupAddress))
      return "invalid backup wallet address";
        ...
        <MDBody>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <CustomButton
                disabled={crud}
                text={`${crud ? "Loading..." : "Create Vault"}`}
                size="small"
              />
            </div>
          </Form>
